        ...
        Pass
        {
            ...
            HLSLPROGRAM
                ...
                Varyings vert(Attributes input)
                {
                    ...
                    // Use shader properties if instance properties aren't set
                    if (windParams.x == 0)
                    {
                    ...
                    if (height > 0.01)
                    {
                        // Wind is stronger at the top of the vegetation
            ...
            HLSLPROGRAM
                ...
                Varyings vert(Attributes input)
                {
                    ...
                    if (height > 0.01)
                    {
                        float windStrength = height * windParams.x;
                        float3 worldPos    = TransformObjectToWorld(vertexPosition.xyz);
                        float  windNoise   = sin(windTime + worldPos.x * 0.1 * windParams.y
                                                 + worldPos.z * 0.1 * windParams.y);
